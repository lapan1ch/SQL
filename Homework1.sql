...
values
    ('John', 'Doe', 'Developer', 28, 'N', 'johndoe'),
    ('Alice', 'Smith', 'Designer', 35, 'Y', 'alicesmith'),
    ('Bob', 'Johnson', 'Manager', 45, 'N', 'bobjohnson'),
    ('Eve', 'Davis', 'Analyst', 31, 'N', 'evedavis'),
    ('Charlie', 'Brown', 'Developer', 29, 'Y', 'charliebrown');
